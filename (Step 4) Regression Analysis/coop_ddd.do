...
foreach g in undocu highprob highrecall lowprob {
    ...
    foreach t in n3 n2 n1 p0 p1 p2 {
...
esttab h_logical h_highprob h_highrecall h_lowprob using "Output/Tables/hundermatch_coop_ddd.tex", replace label booktabs drop($covars _cons *#* *degfield_broader*) ///
...
esttab v_logical v_highprob v_highrecall v_lowprob using "Output/Tables/vmismatch_coop_ddd.tex", replace label booktabs drop($covars _cons *#* *degfield_broader*) ///
    rename(did_undocu "TRIPLE" did_highprob "TRIPLE" did_highrecall "TRIPLE" did_lowprob "TRIPLE") ///
    mlabel("Logical" "High Prob" "High Recall" "Low Prob") ///
    varlabels(TRIPLE "`triple_label'" trend_post_fb "`fb_label'") ///
    stats(ymean r2 N, labels("Mean DepVar" "R-squared" "N") fmt(%9.3f %9.3f %9.0fc)) ///
...
esttab l_logical l_highprob l_highrecall l_lowprob using "Output/Tables/wage_coop_ddd.tex", replace label booktabs drop($covars _cons *#* *degfield_broader*) ///
    rename(did_undocu "TRIPLE" did_highprob "TRIPLE" did_highrecall "TRIPLE" did_lowprob "TRIPLE") ///
    mlabel("Logical" "High Prob" "High Recall" "Low Prob") ///
    varlabels(TRIPLE "`triple_label'" trend_post_fb "`fb_label'") ///
    stats(ymean r2 N, labels("Mean DepVar" "R-squared" "N") fmt(%9.3f %9.3f %9.0fc)) ///
...
* --- OUTCOME: EARNINGS (L) ---
reghdfe ln_adj es_undocu_n3 es_undocu_n2 o.es_undocu_n1 es_undocu_p0 es_undocu_p1 es_undocu_p2 ///
    es_fb_n3 es_fb_n2 o.es_fb_n1 es_fb_p0 es_fb_p1 es_fb_p2 ///
...
coefplot, keep(es_undocu_*) omitted vertical yline(0) xline(3.5, lpattern(dash)) legend(off) ///
    coeflabels(es_undocu_n3="-3" es_undocu_n2="-2" es_undocu_n1="-1" es_undocu_p0="0" es_undocu_p1="1" es_undocu_p2="2") ///
    title("Logical Edits") ytitle("Log Wage") name(g_L_undocu, replace)

reghdfe ln_adj es_highprob_n3 es_highprob_n2 o.es_highprob_n1 es_highprob_p0 es_highprob_p1 es_highprob_p2 ///
    es_fb_n3 es_fb_n2 o.es_fb_n1 es_fb_p0 es_fb_p1 es_fb_p2 ///
...
coefplot, keep(es_highprob_*) omitted vertical yline(0) xline(3.5, lpattern(dash)) legend(off) ///
    coeflabels(es_highprob_n3="-3" es_highprob_n2="-2" es_highprob_n1="-1" es_highprob_p0="0" es_highprob_p1="1" es_highprob_p2="2") ///
    title("GBM High Prob") ytitle("Log Wage") name(g_L_highprob, replace)

reghdfe ln_adj es_highrecall_n3 es_highrecall_n2 o.es_highrecall_n1 es_highrecall_p0 es_highrecall_p1 es_highrecall_p2 ///
    es_fb_n3 es_fb_n2 o.es_fb_n1 es_fb_p0 es_fb_p1 es_fb_p2 ///
...
coefplot, keep(es_highrecall_*) omitted vertical yline(0) xline(3.5, lpattern(dash)) legend(off) ///
    coeflabels(es_highrecall_n3="-3" es_highrecall_n2="-2" es_highrecall_n1="-1" es_highrecall_p0="0" es_highrecall_p1="1" es_highrecall_p2="2") ///
    title("GBM High Recall") ytitle("Log Wage") name(g_L_highrecall, replace)

reghdfe ln_adj es_lowprob_n3 es_lowprob_n2 o.es_lowprob_n1 es_lowprob_p0 es_lowprob_p1 es_lowprob_p2 ///
    es_fb_n3 es_fb_n2 o.es_fb_n1 es_fb_p0 es_fb_p1 es_fb_p2 ///
...
coefplot, keep(es_lowprob_*) omitted vertical yline(0) xline(3.5, lpattern(dash)) legend(off) ///
    coeflabels(es_lowprob_n3="-3" es_lowprob_n2="-2" es_lowprob_n1="-1" es_lowprob_p0="0" es_lowprob_p1="1" es_lowprob_p2="2") ///
    title("GBM Low Prob") ytitle("Log Wage") name(g_L_lowprob, replace)

* --- OUTCOME: HORIZONTAL UNDERMATCH (H) ---
reghdfe hundermatched es_undocu_n3 es_undocu_n2 o.es_undocu_n1 es_undocu_p0 es_undocu_p1 es_undocu_p2 ///
    es_fb_n3 es_fb_n2 o.es_fb_n1 es_fb_p0 es_fb_p1 es_fb_p2 ///
    $covars i.degfield_broader $int_undocu [pweight=norm_w_undocu], absorb(stack_id#statefip#year stack_id#statefip#undocu stack_id#year#undocu) vce(cluster statefip) compact
coefplot, keep(es_undocu_*) omitted vertical yline(0) xline(3.5, lpattern(dash)) legend(off) ///
    coeflabels(es_undocu_n3="-3" es_undocu_n2="-2" es_undocu_n1="-1" es_undocu_p0="0" es_undocu_p1="1" es_undocu_p2="2") ///
...
reghdfe hundermatched es_highprob_n3 es_highprob_n2 o.es_highprob_n1 es_highprob_p0 es_highprob_p1 es_highprob_p2 ///
    es_fb_n3 es_fb_n2 o.es_fb_n1 es_fb_p0 es_fb_p1 es_fb_p2 ///
    $covars i.degfield_broader $int_gbm_high_prob [pweight=norm_w_gbm_high_prob], absorb(stack_id#statefip#year stack_id#statefip#gbm_high_prob stack_id#year#gbm_high_prob) vce(cluster statefip) compact
coefplot, keep(es_highprob_*) omitted vertical yline(0) xline(3.5, lpattern(dash)) legend(off) ///
    coeflabels(es_highprob_n3="-3" es_highprob_n2="-2" es_highprob_n1="-1" es_highprob_p0="0" es_highprob_p1="1" es_highprob_p2="2") ///
...
reghdfe hundermatched es_highrecall_n3 es_highrecall_n2 o.es_highrecall_n1 es_highrecall_p0 es_highrecall_p1 es_highrecall_p2 ///
    es_fb_n3 es_fb_n2 o.es_fb_n1 es_fb_p0 es_fb_p1 es_fb_p2 ///
    $covars i.degfield_broader $int_gbm_high_recall [pweight=norm_w_gbm_high_recall], absorb(stack_id#statefip#year stack_id#statefip#gbm_high_recall stack_id#year#gbm_high_recall) vce(cluster statefip) compact
coefplot, keep(es_highrecall_*) omitted vertical yline(0) xline(3.5, lpattern(dash)) legend(off) ///
    coeflabels(es_highrecall_n3="-3" es_highrecall_n2="-2" es_highrecall_n1="-1" es_highrecall_p0="0" es_highrecall_p1="1" es_highrecall_p2="2") ///
...
reghdfe hundermatched es_lowprob_n3 es_lowprob_n2 o.es_lowprob_n1 es_lowprob_p0 es_lowprob_p1 es_lowprob_p2 ///
    es_fb_n3 es_fb_n2 o.es_fb_n1 es_fb_p0 es_fb_p1 es_fb_p2 ///
    $covars i.degfield_broader $int_gbm_low_prob [pweight=norm_w_gbm_low_prob], absorb(stack_id#statefip#year stack_id#statefip#gbm_low_prob stack_id#year#gbm_low_prob) vce(cluster statefip) compact
coefplot, keep(es_lowprob_*) omitted vertical yline(0) xline(3.5, lpattern(dash)) legend(off) ///
    coeflabels(es_lowprob_n3="-3" es_lowprob_n2="-2" es_lowprob_n1="-1" es_lowprob_p0="0" es_lowprob_p1="1" es_lowprob_p2="2") ///
...
reghdfe vmismatched es_undocu_n3 es_undocu_n2 o.es_undocu_n1 es_undocu_p0 es_undocu_p1 es_undocu_p2 ///
    es_fb_n3 es_fb_n2 o.es_fb_n1 es_fb_p0 es_fb_p1 es_fb_p2 ///
    $covars i.degfield_broader $int_undocu [pweight=norm_w_undocu], absorb(stack_id#statefip#year stack_id#statefip#undocu stack_id#year#undocu) vce(cluster statefip) compact
coefplot, keep(es_undocu_*) omitted vertical yline(0) xline(3.5, lpattern(dash)) legend(off) ///
    coeflabels(es_undocu_n3="-3" es_undocu_n2="-2" es_undocu_n1="-1" es_undocu_p0="0" es_undocu_p1="1" es_undocu_p2="2") ///
...
reghdfe vmismatched es_highprob_n3 es_highprob_n2 o.es_highprob_n1 es_highprob_p0 es_highprob_p1 es_highprob_p2 ///
    es_fb_n3 es_fb_n2 o.es_fb_n1 es_fb_p0 es_fb_p1 es_fb_p2 ///
    $covars i.degfield_broader $int_gbm_high_prob [pweight=norm_w_gbm_high_prob], absorb(stack_id#statefip#year stack_id#statefip#gbm_high_prob stack_id#year#gbm_high_prob) vce(cluster statefip) compact
coefplot, keep(es_highprob_*) omitted vertical yline(0) xline(3.5, lpattern(dash)) legend(off) ///
    coeflabels(es_highprob_n3="-3" es_highprob_n2="-2" es_highprob_n1="-1" es_highprob_p0="0" es_highprob_p1="1" es_highprob_p2="2") ///
...
reghdfe vmismatched es_highrecall_n3 es_highrecall_n2 o.es_highrecall_n1 es_highrecall_p0 es_highrecall_p1 es_highrecall_p2 ///
    es_fb_n3 es_fb_n2 o.es_fb_n1 es_fb_p0 es_fb_p1 es_fb_p2 ///
    $covars i.degfield_broader $int_gbm_high_recall [pweight=norm_w_gbm_high_recall], absorb(stack_id#statefip#year stack_id#statefip#gbm_high_recall stack_id#year#gbm_high_recall) vce(cluster statefip) compact
coefplot, keep(es_highrecall_*) omitted vertical yline(0) xline(3.5, lpattern(dash)) legend(off) ///
    coeflabels(es_highrecall_n3="-3" es_highrecall_n2="-2" es_highrecall_n1="-1" es_highrecall_p0="0" es_highrecall_p1="1" es_highrecall_p2="2") ///
...
reghdfe vmismatched es_lowprob_n3 es_lowprob_n2 o.es_lowprob_n1 es_lowprob_p0 es_lowprob_p1 es_lowprob_p2 ///
    es_fb_n3 es_fb_n2 o.es_fb_n1 es_fb_p0 es_fb_p1 es_fb_p2 ///
    $covars i.degfield_broader $int_gbm_low_prob [pweight=norm_w_gbm_low_prob], absorb(stack_id#statefip#year stack_id#statefip#gbm_low_prob stack_id#year#gbm_low_prob) vce(cluster statefip) compact
coefplot, keep(es_lowprob_*) omitted vertical yline(0) xline(3.5, lpattern(dash)) legend(off) ///
    coeflabels(es_lowprob_n3="-3" es_lowprob_n2="-2" es_lowprob_n1="-1" es_lowprob_p0="0" es_lowprob_p1="1" es_lowprob_p2="2") ///
